...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080c14] flex flex-col">
      ...
      {/* ── Hero ── */}
      <div className="relative flex flex-col items-center justify-center pt-14 pb-8 px-6 overflow-hidden min-h-[75vh]">
        {/* Stadium background */}
        ...
        <p className="relative text-white/80 text-xs tracking-[0.2em] uppercase mt-2 text-center drop-shadow">
          USA · Canada · Mexico
        </p>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8 w-full max-w-sm mx-auto">
        <p className="text-center text-sm text-[#94a3b8] mb-6">Sign in to make your predictions</p>
